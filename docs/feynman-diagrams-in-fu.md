...
### 1. Functional Interpretation of Diagrams
...
### 2. Two-Vertex, Sine-Wave-as-$d\tau$ Picture
...
$$
f_n \xrightarrow{d\tau} f_{n+1}, \quad
d\tau = \int_{\lambda_{\rm init}}^{\lambda_{\rm commit}} \mathcal{A}(\text{possible transitions}), d\lambda
$$
...
### 4. Virtual Particles as Aggregations
...
### 5. Directed Acyclic Graph (DAG) Representation
