...
**Claim**
The universe is fundamentally a compositional structure of functions; objects and states are derivative.
...
**Claim**
Every irreducible transition carries a minimum entropy increase $\Delta S_{\min}$.
...
**Claim**
Causality is defined by ordered composability of transitions; only composable transitions can influence one another.
...
**Claim**
A universal upper bound on causal composition speed exists and is invariant.
