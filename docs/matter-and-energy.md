...
## 2. Standing Patterns of Transitions: Matter
...
## 4. Energy as Transition Potential
...
> In FU, **matter is transitory**: it persists only so long as its constituent transitions reinforce one another.
> Energy and entropy emerge naturally from the dynamics, without invoking classical metaphysics, forces, or primitive entities.
