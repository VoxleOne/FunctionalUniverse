...
## Function Composition and Aggregation in the Functional Universe
...
### 2. Function Composition: The Engine of Reality
...
### 3. Function Aggregation: The Domain of Possibility
...
### 4. The Aggregation–Composition Boundary: Commitment
...
**Summary:** Hawking radiation is aggregation filtered by horizon-constrained composition:

$$
\text{Aggregated virtual pairs } \mathcal{A} ;\xrightarrow{\text{decoherence + threshold}} ;\text{real particles } f_{\text{ext}}.
$$
